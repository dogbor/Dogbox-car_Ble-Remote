...
{ 255,2,0,8,0,37,1,10,28,5,
  ...
  15,31,7,7,0,68,17,5,71,55,
  19,0,28,25,131,1,4,2,55,6,
  1,26,16,68,79,71,66,79,88,0,
  129,0,20,96,19,2,0,26,80,111,
  119,101,114,101,100,32,98,121,32,100,
  111,103,66,111,88,0,129,0,5,68,
  ...
  224,184,149,224,185,140,41,0,66,128,
  50,3,6,4,0,2,26,129,0,50,
  9,6,3,0,26,87,105,102,105,0 };
    
struct {
    // input variables
  uint8_t SW_Power; // =1 if switch ON and =0 if OFF     //Open or close SW1
  uint8_t BU_EngStart; // =1 if button pressed, else =0    //Open/close BUT1
...
#define REMOTEXY_CLOUD_TOKEN "d65cbeccf5198ad56374e97923e5261c" //-- Project: DoorControl_V1_testing --
#define REMOTEXY_ACCESS_PASSWORD "1234"  //set passwoard
